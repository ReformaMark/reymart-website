...
import { useInView } from "@/hooks/use-on-screen";
...
export default function Home() {
  ...
  const vehiclesRef = useRef<HTMLElement | null>(null);
  ...
  return (
    <div className="flex flex-col overflow-hidden min-h-screen">
      ...
      <section ref={setRefs} className="flex flex-col">
        ...
        <section
          ref={contactRef}
          className="py-20 px-4 md:px-6 bg-gray-900 text-white"
          id="contact"
        >
          <div className="container mx-auto max-w-6xl">
          ...
          <div className="container mx-auto max-w-6xl">
            <div className="flex flex-col md:flex-row justify-between items-center">
              ...
              <div className="text-sm">
                © {new Date().getFullYear()} Reymart Marfil. All rights
                reserved.
              </div>
            </div>
          </div>
      ...
      <BackToTopButton onClick={backToTop} show={isInView} />
    </div>
  );
}
